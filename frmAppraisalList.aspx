<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmAppraisalList.aspx.vb" Inherits="frmAppraisalList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdateProgress ID="updProgress" AssociatedUpdatePanelID="updFormPanel" runat="server">
      ...
      <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>My Appraisal List...</span></h2></div>
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width:95%" >
                    ...
                    <asp:Panel ID="pnlGrid" runat ="server"   >
                                ...
                                <asp:GridView  Width="100%" ID="gridAppraisals" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridAppraisal_RowDataBound" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" 
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="Appraisal_No" HeaderText="Appraisal No" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="Employee_No" HeaderText="Employee No" ItemStyle-Width="100"/> 
                                        <asp:BoundField DataField="EmployeeName" HeaderText="Full Name" ItemStyle-Width="300"/>
                                        <asp:BoundField DataField="Appraisal_Period" HeaderText="Appraisal Period" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="Appraisal_Type" HeaderText="Appraisal Half" ItemStyle-Width="70" />
                                        <asp:BoundField DataField="Appraisal_Date" HeaderText="Appraisal Date" ItemStyle-Width="60" DataFormatString="{0:d}" />
        ...
        <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; height :20px; ">
             <div style="float:left ; ">
                <%-- <asp:ImageButton ID="btnNew" runat ="server" ImageUrl="~/images/add.png" ToolTip="Add New Application" Visible="true"/>--%>
                 ...
                 <asp:Button ID="btnNew" runat="server" Text="Create New Appraisal" CssClass ="button"  />
        ...
        <div id="dvResponse">
            ...
            <span id="spNewAppraisal" runat="server" visible="false">
