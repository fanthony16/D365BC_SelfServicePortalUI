<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmCanteenApplicationList.aspx.vb" Inherits="frmCanteenApplicationList" EnableEventValidation="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>My Canteen Application List...</span></h2></div>
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width:95%" >
                ...
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">--%>
                                ...
                                <asp:GridView  Width="100%" ID="gridCanteenApp" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridCanteenApp_RowDataBound" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" 
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="TicketNo" HeaderText="Ticket No" ItemStyle-Width="100" />
                                        ...
                                        <asp:BoundField DataField="DepartmentCode" HeaderText="Department Code" ItemStyle-Width="300"/>
                                        <asp:BoundField DataField="RequestType" HeaderText="Request Type" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="RequestDate" HeaderText="Request Date" ItemStyle-Width="60" DataFormatString="{0:d}" />
                                        <asp:BoundField DataField="VisitorName" HeaderText="Visitor Name" ItemStyle-Width="300" />
                                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Width="50" />
                                        <asp:BoundField DataField="ResponsibilityCenter" HeaderText="Responsibility Center" ItemStyle-Width="50" />
                                       <%-- <asp:BoundField DataField="PayrollPeriod" HeaderText="Payroll Period" ItemStyle-Width="60" DataFormatString="{0:d}" />--%>
                                       ...
                                       <asp:TemplateField HeaderText="">
                                              <ItemTemplate>
                                                  ...
                                                  <asp:ImageButton OnClick="BtnViewDetails_Click"  ID="btnViewApplicationLog" runat ="server" ImageUrl="~/images/edit.jpg" ToolTip="View Canteen Application" ItemStyle-Width ="10px" />
        ...
        <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; height :20px; ">
             <div style="float:left ; ">
                <%-- <asp:ImageButton ID="btnNew" runat ="server" ImageUrl="~/images/add.png" ToolTip="Add New Application" Visible="true"/>--%>
                 ...
                 <asp:Button ID="btnNew" runat="server" Text="Create Canteen Application" CssClass ="button"  />
                        ...
                        <asp:Panel ID="Panel5" Width ="98%" runat ="server" BorderStyle="Solid" Height ="600px" BorderWidth ="2px">
                                                    <asp:GridView Width="100%" ID="gridApprovalEntries" runat="server" Visible="true" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" OnRowDataBound ="gridApprovalEntries_RowDataBound">
                                                         <Columns>
                                                              ...
                                                              <asp:BoundField DataField="DocumentNo" HeaderText="Ticket No" />
