<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmStaffClaimList.aspx.vb" Inherits="frmStaffClaimList" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>Staff Claim List...</span></h2></div>
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width:95%" >
                ...
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">--%>
                                ...
                                <asp:GridView  Width="100%" ID="gridStaffClaim" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridClaim_RowDataBound" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" 
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="AccountNo" HeaderText="Account No" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="Cashier" HeaderText="Cashier" ItemStyle-Width="100"/> 
                                        <asp:BoundField DataField="Payee" HeaderText="Payee" ItemStyle-Width="300"/>
                                        <asp:BoundField DataField="Purpose" HeaderText="Purpose" ItemStyle-Width="300"/>
                                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="BankName" HeaderText="Bank Name" ItemStyle-Width="300" />
                                        <asp:BoundField DataField="BankAccount" HeaderText="Bank Account" ItemStyle-Width="50" />
                                       ...
                                       <asp:TemplateField HeaderText="">
                                              <ItemTemplate>
                                                  ...
                                                  <asp:ImageButton OnClick="BtnViewDetails_Click"  ID="btnViewApplicationLog" runat ="server" ImageUrl="~/images/edit (1).png" ToolTip="View Claim" ItemStyle-Width ="10px" />
        ...
        <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; height :20px; ">
             <div style="float:left ; ">
                <%-- <asp:ImageButton ID="btnNew" runat ="server" ImageUrl="~/images/add.png" ToolTip="Add New Application" Visible="true"/>--%>
                 ...
                 <asp:Button ID="btnNew" runat="server" Text="New Claim" CssClass ="button"  />
