<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmStoreRequisitionList.aspx.vb" Inherits="frmStoreRequisitionList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdateProgress ID="updProgress" AssociatedUpdatePanelID="updFormPanel" runat="server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>Store Requisition List...</span></h2></div>
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width:95%" >
                ...
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="UserID" HeaderText="Requester" ItemStyle-Width="400" />
                                        <asp:BoundField DataField="RequestDate" HeaderText="Request Date" ItemStyle-Width="150" DataFormatString="{0:d}" />
                                        <%--<asp:BoundField DataField="IssuingStore" HeaderText="Issuing Store" ItemStyle-Width="150" />
                                        <asp:BoundField DataField="Description" HeaderText="Description" ItemStyle-Width="350"/>--%>
                                        <asp:BoundField DataField="TotalAmount" HeaderText="Total Amount" ItemStyle-Width="300"/>
        ...
        <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; height :20px; ">
             <div style="float:left ; ">
                <%-- <asp:ImageButton ID="btnNew" runat ="server" ImageUrl="~/images/add.png" ToolTip="Add New Application" Visible="true"/>--%>
                 ...
                 <asp:Button ID="btnNew" runat="server" Text="New Requisition" CssClass ="button"  />
