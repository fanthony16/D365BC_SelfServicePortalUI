<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmProbationConfirmations.aspx.vb" Inherits="frmProbationConfirmations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdateProgress ID="updProgress" AssociatedUpdatePanelID="updFormPanel" runat="server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>Probation Confirmation List...</span></h2></div>
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width:95%" >
                ...
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">--%>
                                ...
                                <asp:GridView  Width="100%" ID="gridProbationConfirmation" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridProbationConfirmation_RowDataBound" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header"  EmptyDataText ="No Record Found"
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="ApplicationNo" HeaderText="No" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="EmployeeNo" HeaderText="Employee No" ItemStyle-Width="100" />
                                        <asp:BoundField DataField="EmployeeName" HeaderText="Employee Name" ItemStyle-Width="400" />
                                        <asp:BoundField DataField="EmploymentDate" HeaderText="Employment Date" ItemStyle-Width="150" DataFormatString="{0:d}" />
                                        <asp:BoundField DataField="AppraisalType" HeaderText="Appraisal Type" ItemStyle-Width="300"/>
                                       ...
                                       <asp:TemplateField HeaderText="">
                                              <ItemTemplate>
                                                  ...
                                                  <asp:ImageButton OnClick="BtnViewDetails_Click"  ID="btnViewApplicationLog" runat ="server" ImageUrl="~/images/edit.JPG" ToolTip="View Claim" ItemStyle-Width ="10px" />
