<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="frmStaffAdvance.aspx.vb" Inherits="frmStaffAdvance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div class ="bodyMainDiv">
                <div id="dvMainDvTitle" style ="padding :20px;"><h2><span id="spCaption" runat="server">Cash Advance Request </span></h2></div>
                <div id="dvPersonalDetails" style="width :100%">
                                     <div id="dvPersonalfor" style="float :left ; width :50%; ">    
                                          ...
                                          <div id="dvCashier" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Requestor ID:</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                       ...
                                       <%--   <div id="dvPaying_Bank_Account" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Paying Account No :</span>
                                               </div>
                                               <div style ="text-align :left ;">
            ...
            <div class ="bodyMainDiv" style="margin-top: 20px;">
                ...
                RowStyle-CssClass="rows" OnPageIndexChanging="datagrid_PageIndexChanging" EnableSortingAndPagingCallbacks="false">
                                 ...
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="Advance_Type" HeaderText="Advance Type" ItemStyle-Width="200" />
                                        <%--<asp:BoundField DataField="Advance_Narration" HeaderText="Narration" ItemStyle-Width="500" />--%>
                                        <asp:BoundField DataField="Amount" HeaderText="Amount" ItemStyle-Width="200" />
