<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmLeaveApp.aspx.vb" Inherits="frmLeaveApp" %>
                    ...
                    <asp:AccordionPane ID="ContactAddress"  runat="server">
                        ...
                        <Content>
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div id="dvLeavePeriod" class ="dvBoxRows">
                                     <div class="dvBoxRowsFieldLabel">
                                          <span style ="font-size : medium;">Leave Period :</span>
                                     </div>
                                     <div style ="text-align :left ;">
                                          <%--<asp:TextBox ID="txtLeavePeriod" Width ="300px" runat="server"></asp:TextBox>--%>
                                          <asp:DropDownList ID="ddLeavePeriod" runat="server" Width="300px" CausesValidation="False" AutoPostBack="True"></asp:DropDownList>
                                ...
                                <div id="dvLeaveType" class ="dvBoxRows">
                                     ...
                                     <div style ="text-align :left ;">
                                          ...
                                          <asp:DropDownList ID="ddLeaveType" runat="server" Width="300px" CausesValidation="False" AutoPostBack="True"></asp:DropDownList>                         
                                ...
                                <div  style="float :left ; width :35%; height :360px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#fec84c; text-align:center; padding-top : 3px; font-size: 16px;">
                                          <span style="color:black ;">Leave Documents</span>
                                ...
                                <div id="dvAddress2" style="float :left ; width :30%; height :360px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#fec84c; text-align:center; padding-top : 3px; font-size: 16px;">
                                ...
                                <%--          <div id="dvExamLeaveBalance" class ="dvBoxRows" style="margin-top : 15px;">
                                          ...
                                          <div id="dvMaxLeaveDays" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Maximum Leave Days :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtMaxLeaveDays" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                          ...
                                          <div id="dvApplicationDate" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtApplicationDatee" Width ="300px" runat="server" Enabled="false"></asp:TextBox>
                                ...
                                <div id="dvAddress3" style="float :left ; width :30%; height :360px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;background-color :#fec84c; text-align:center; padding-top : 3px; font-size: 16px;">
                                          <span style=" color:black ;">Leave Details</span>
                                          ...
                                          <div id="dvAnnualLeaveTaken" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Annual Leave Taken :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtAnnualLeaveTaken" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                          ...
                                          <div id="dvLeaveBalance" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtLeaveBalance" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                          ...
                                          <div id="dvAppliedDays" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium; text-align :left;">Days Applied :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtAppliedDays" Width ="300px" runat="server" Enabled="true"></asp:TextBox>
                                     ...
                                     <div id="dvRLV" style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#fec84c; text-align:center; padding-top : 3px; font-size: 16px;" runat ="server" >
                                          ...
                                          <div id="dvReleaver" class ="dvBoxRows" style="margin-top : 15px; margin-left :7px;">
                                               <asp:Panel ID="pnlUploadDetail" Width ="98%" runat ="server" BorderStyle="Solid" Height ="290px" BorderWidth ="2px">
                                                    <asp:GridView Width="100%" ID="gridReleaver" runat="server" Visible="true"  AutoGenerateColumns="False" >
                                                         <Columns>
